...
public class ServidorOrig {
    ...
    private static String file_private = "/tmp/rsa.pri";
    private static String file_public = "/tmp/rsa.pub";
    ...
    public ServerSocket getServerSockete() {
        return ServerSockete;
    }

    public void setServerSockete(ServerSocket serverSockete) {
        ServerSockete = serverSockete;
    }
